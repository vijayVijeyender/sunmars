    ...
    <div className="container position-relative">
        ...
        <div className="row d-flex justify-content-center">
            ...
            <div className="col-md-6 col-lg-5 col-xl-4">
                <div>
                    <form className="p-3 p-xl-4" data-bss-recipient="925dcb329ba53254cb6124ee6e18a808">
                        <div className="mb-3"><input className="form-control" id="name-1" type="text" name="name" placeholder="Name" /></div>
                        <div className="mb-3"><input className="form-control" id="email-1" type="email" name="email" placeholder="Email" /></div>
